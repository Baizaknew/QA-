...
describe('Clients Suit', ()=> {
    ...
    it('Create client', async ()=> {
        ...
        await surnameField.setValue('Kenaiv');

        const firstnameField = await $('input[formcontrolname="userName"]');
        await firstnameField.setValue('Armin');
        ...
        await emailField.setValue('some.email12@gmail.com');

        const phoneNumberField = await $('input[formcontrolname="phone"]');
        await phoneNumberField.setValue('996766567876');

        const datebirthField = await $('input[formcontrolname="birthday"]');
        await datebirthField.setValue('02.10.2020');
